...
"}")
        ...
        self.button_answer.clicked.connect(LatexamWindow.sendMessage)
        self.button_next.clicked.connect(LatexamWindow.onManage)
        self.button_previous.clicked.connect(LatexamWindow.onTool)
